...
import { AlertCircle, ArrowLeft, RefreshCw, MessageCircle, CheckCircle2, CreditCard, HelpCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/30 flex items-center justify-center p-4">
      <div className="w-full max-w-lg space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold text-foreground text-balance">Payment Cancelled</h1>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="text-center pb-4">
            <CardDescription className="text-base leading-relaxed">
              Your payment was safely cancelled and no charges were made to your account. This can happen for various
              reasons, and it's completely normal.
            </CardDescription>
          </CardHeader>
