...
//       const payload = {
//         user_id: 'ZOxldv', // Replace with actual user ID (e.g., from auth context)
//         vendor_ids: Array.from(new Set(cartItems.map((item) => item.vendorId || 'mmoN2b'))),
//         product_ids: cartItems.map((item) => item.id),
//         item_details: cartItems.reduce((acc, item) => ({
//           ...acc,
//           [item.id]: {
//             name: item.name,
...
//           },
//         }), {}),
//         amount: orderTotal, // Total including GST and shipping
//         address: {
...
//       setOrderId(data.order_id); // Store order ID for confirmation step
...
//                   <div className="mb-6 rounded-md border p-4 text-left">
//                     <h3 className="mb-2 font-medium">Order Number</h3>
//                     <p className="text-lg font-bold">{orderId || 'Pending'}</p>
//                   </div>
