        ...
        <div className="p-4">
          ...
          <div className="space-y-2 mb-4">
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm text-muted-foreground">({vendor.reviewCount.toLocaleString()})</span>
            </div>
          ...
          <Link href={`/vendors/${vendor.slug}`} className="block">
            <Button className="w-full group-hover:bg-primary/90 transition-colors">Visit Store</Button>
          </Link>
        </div>
      </CardContent>
    </Card>
